...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "14f82e99-275c-4789-b6ee-0256840d4a9d");
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        I'd love to hear from you! If you have any enquiries, feedback or questions, please use the form below. </motion.p>
